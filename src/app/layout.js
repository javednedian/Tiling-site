          ...
          <div className="container">
            <div className="row">
              <div className="col-md-3 mb-4">
                ...
                <p className="">At [Company], we believe every wall has the potential to inspire. With a focus on quality, precision, and design, we offer professional painting services that elevate spaces and reflect your unique style.</p>
              </div>
